...
window.studentObject =
  ...
  allowInputNumber: ->
    ...
    $('#user_first_name').filter_input({regex:'[a-zA-Z_.]', live:true})
    $('#user_last_name').filter_input({regex:'[a-zA-Z_.]', live:true}) 
    ...
    $('#student_first_name').filter_input({regex:'[a-zA-Z_.]', live:true})
    $('#student_last_name').filter_input({regex:'[a-zA-Z_.]', live:true}) 
    return
  uploadPhoto: ->

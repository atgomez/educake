...
window.helper = 
  ...
  allowInputNumber: ->
    ...
    $('#user_first_name').filter_input({regex:'[a-zA-Z0-9- ]', live:true})
    $('#user_last_name').filter_input({regex:'[a-zA-Z0-9- ]', live:true}) 
    ...
    $('.valid_name').filter_input({regex:'[a-zA-Z0-9- ]', live:true})
